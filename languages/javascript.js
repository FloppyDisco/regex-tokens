module.exports = [
...

  {
    ...
    children: [
      ...
      { token: "(?<=...)", copyValue:"(?<=)", description: "Positive lookbehind. Matches a group only if preceded by a pattern." },
      { token: "(?<!...)", copyValue:"(?<!)", description: "Negative lookbehind. Matches a group only if NOT preceded by a pattern." },
      { token: "(?=...)", copyValue:"(?=)", description: "Positive lookahead. Matches a group only if followed by a pattern." },
      { token: "(?!...)", copyValue:"(?!)", description: "Negative lookahead. Matches a group only if NOT followed by a pattern." },
    ],
  },
...

  {
    ...
    children: [
      { token: "(...)", copyValue:"()", description: "Capturing group. It groups part of the regex for applying quantifiers or extracting parts of the match." },
      ...
      { token: "(?:...)", copyValue:"(?:)", description: "Non-capturing group. Groups part of the regex but does not create a backreference." },
      { token: "()|()", description: "Alternation (OR operator). Allows one of several options to match." },
      { token: "(?<=...)", copyValue:"(?<=)", description: "Positive lookbehind. Ensures that a specific pattern precedes." },
      { token: "(?<!...)", copyValue:"(?<!)", description: "Negative lookbehind. Ensures that a specific pattern does not precede." },
    ],
  },
];
